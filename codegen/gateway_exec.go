...
func ExecWithFS(ctx context.Context, cln solver.Client, fs Filesystem, opts Option, stdin io.Reader, stdout, stderr io.Writer, extraEnv []string, args ...string) error {
	var (
	...
	return solver.Build(ctx, cln, fs.SessionOpts, func(ctx context.Context, c gateway.Client) (res *gateway.Result, err error) {
